                            ...
                            <div className="text-end d-flex">
                                ...
                                <div className="btn-group me-2">
                                    ...
                                    <ul className="dropdown-menu dropdown-menu-end pt-2">
                                        <li><a className="dropdown-item" href=""><i
                                            className="fa fa-palette me-2"/>My Arts</a></li>
                                        <li><a className="dropdown-item" href="#"><i className="fa fa-user-edit me-2"/>My
                                            Account</a></li>
                                        <li><a className="dropdown-item" href=""><i
                                            className="fa fa-sign-out-alt me-2"/>Logout</a></li>
                                    </ul>
                                </div>
                                ...
                                <div className="btn-group me-2">
                                    <button type="button" className="btn btn-outline-secondary dropdown-toggle"
                                            data-bs-toggle="dropdown"
                                            aria-expanded="false">
                                        <img className='me-2' src={ImgCircle} height="25px"/> US$ 0.00

                                    </button>
                                    <ul className="dropdown-menu dropdown-menu-end pt-2">
                                        <li><a className="dropdown-item" href=""><i
                                            className="fa fa-wallet me-2"/> My Wallet</a></li>
                                        <li><a className="dropdown-item" href="#"><i
                                            className="fa fa-money-check-alt me-2"/>Add Funds</a></li>
                                    </ul>
                                </div>


                                <a className="btn btn-outline-secondary me-2 ">
                                    <img className="" src={ImgMetaMask} height="25px"/>
                                </a>

                                <a className="btn btn-outline-secondary">
                                    <img className="" src={ImgPhantom} height="25px"/>
                                </a>
